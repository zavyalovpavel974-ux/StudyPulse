...
<section class="cards"><div class="card"><div class="label">手机总使用</div><div class="num">{v['phone']}</div></div><div class="card"><div class="label">学习 App</div><div class="num">{v['study']}</div></div><div class="card"><div class="label">Windows 学习</div><div class="num">{v['output']:.1f}</div></div><div class="card"><div class="label">分心风险</div><div class="num">{v['risk']:.1f}</div></div></section>
...
<section class="grid2"><div class="panel"><h2>Windows 学习文件活动</h2><table><tbody>{file_rows(ctx['files'])}</tbody></table></div><div class="panel"><h2>RStudio 学习痕迹</h2>{r_summary_items(ctx['r_summary'])}</div></section>
...
<section class="hero"><div class="panel"><div class="muted">今日分心风险</div><div class="score">{v['risk']:.1f}</div><p class="muted">分心类时长占比 {v['ratio']}。该指标用于提示风险，不做评价。</p>{v['risk_chart']}</div><div class="panel"><h2>今日行动线索</h2><div class="timeline"><div class="step"><i></i><div><strong>学习投入</strong><div class="muted">学习类 App 使用 {v['study']}。</div></div></div><div class="step"><i></i><div><strong>Windows 学习记录</strong><div class="muted">Windows 学习记录指数 {v['output']:.1f}。</div></div></div><div class="step"><i></i><div><strong>复盘建议</strong><div class="muted">{h(v['review'])}</div></div></div></div></div></section>
<section class="metrics"><div class="metric"><span class="muted">手机总使用</span><strong>{v['phone']}</strong></div><div class="metric"><span class="muted">学习 App</span><strong>{v['study']}</strong></div><div class="metric"><span class="muted">Windows 记录</span><strong>{v['output']:.1f}</strong></div></section>
<section class="grid"><div class="panel"><h2>时间结构</h2>{bar_list(category_data(ctx['latest']))}</div><div class="panel"><h2>Windows 学习趋势</h2>{v['output_chart']}</div></section>
<section class="grid"><div class="panel"><h2>Top App</h2><table><thead><tr><th>App</th><th>分类</th><th>时长</th><th>打开</th></tr></thead><tbody>{app_rows(ctx['apps'])}</tbody></table></div><div class="panel"><h2>R 与 Windows 文件记录</h2>{r_summary_items(ctx['r_summary'])}<table><tbody>{file_rows(ctx['files'])}</tbody></table></div></section>
...
<section class="cards"><div class="card"><span class="muted">Phone</span><strong>{v['phone']}</strong><span class="muted">总使用</span></div><div class="card"><span class="muted">Study</span><strong>{v['study']}</strong><span class="muted">学习类 App</span></div><div class="card"><span class="muted">Windows</span><strong>{v['output']:.1f}</strong><span class="muted">学习记录指数</span></div><div class="card"><span class="muted">Risk</span><strong>{v['risk']:.1f}</strong><span class="muted">分心风险</span></div></section>
...
<section class="grid"><div class="panel"><h2>Top App 使用</h2><table><thead><tr><th>App</th><th>分类</th><th>时长</th><th>打开</th></tr></thead><tbody>{app_rows(ctx['apps'])}</tbody></table></div><div class="panel"><h2>Windows 学习记录</h2>{r_summary_items(ctx['r_summary'])}<table><tbody>{file_rows(ctx['files'])}</tbody></table></div></section>
